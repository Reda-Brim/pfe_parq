{{-- <table style="width: 100%">
   ...
   <tr>
     ...
     <td>{{$Info->dateAchatVehicules}}</td>

     <td>{{$Info->prixAchatVehicules}}</td>
...
<section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
                ...
                <H2  class="d-flex justify-content-center mb-4 font-weight-bold">Contrat Achat Vehicule </H2>
                <table  class="table"  >
              ...
              <tr style="border: 1px solid #ccc;" >
                <th class="sorting text-danger "   style="border: 1px solid #ccc; "tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style=""><H5>Infos Client :</H5></th>
          ...
          <tr style="border: 1px solid #ccc; text-color:red;" >
            <th class="sorting text-danger"  style="border: 1px solid #ccc;" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" ><h5>Infos Vendeur :</h5></th>
            {{-- <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="">Info Vendeur</th> --}}
      ...
      <tr style="border: 1px solid #ccc;" >
        <th class="sorting text-danger"   style="border: 1px solid #ccc; "tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style=""><h5>Infos Vehicule :</h5></th>
        {{-- <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="">Info Vendeur</th> --}}
  ...
  <tr style="border: 1px solid #ccc;" >
    <th class="sorting text-danger"   style="border: 1px solid #ccc;" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style=""><h5>Infos du Paiement :</h5></th>
    {{-- <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="">Info Vendeur</th> --}}

   <tr>
  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="">Date Achat Vehicules :</th>
  <td>{{$Info->dateAchatVehicules}}</td>
  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="">Prix Achat Vehicule  :</th>

  <td>{{$Info->prixAchatVehicules}} DH</td>
  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="">Type de Paiement :</th>
