...
{{$Info->dureeLocationVehicules}}
{{$Info->dateDebutLocationVehicules}}
{{$Info->dateFinLocationVehicules}} 
{{$Info->coutParJourVehicules}}
{{$Info->typePaiement}} --}}
  ...
  @media print{
   ...
   <div>
      ...
      <div class="d-flex justify-content-end">
        ...
        <center><h1 > Contrat de location d'une voiture</h1></center>
        <div class="fic"> 
        ...
        Kilométrage du véhicule : <strong>{{$Info->kilometrage}}</strong> kms 
         à titre onéreux et à compter du <strong>****</strong>prix<strong>***** </strong>par <strong>***</strong>type paiement <strong>{{$Info->typePaiement}}</strong>.Du <strong>{{$Info->dateDebutLocationVehicules}}</strong> jusqu'au <strong>{{$Info->dateFinLocationVehicules}}</strong>
        ...
        Les parties s'entendent sur un prix de location <strong>{{$Info->coutParJourVehicules}}</strong> DHS par jour.
  ...
  @media print{
   ...
   <div>
      ...
      <div class="d-flex justify-content-end">
        ...
        <div class="fic"> 
           <br><br>
        Appelé ci-après le loueur <strong>{{$Info->nom}} {{$Info->prenom}}</strong>,son numéro de permis est {{$Info->numeroPermis}} habite à  {{$Info->adressClient}} de {{$Info->ville}} son numéro téléphone est {{$Info->telephone}},
        ...
        Le loueur met à disposition du locataire, un véhicule de marque <strong>{{$Info->Marque}}</strong> , immatriculé <strong>{{$Info->matriculeVehicules}}</strong>,
        Kilométrage du véhicule : <strong>{{$Info->kilometrage}}</strong> kms 
         à titre onéreux et à compter du <strong>{{$Info->coutParJourVehicules}}</strong> DHS par jour par <strong>{{$Info->typePaiement}} </strong> .Du <strong>{{$Info->dateDebutLocationVehicules}}</strong> jusqu'au <strong>{{$Info->dateFinLocationVehicules}}</strong>
...
<center> 
        Fait en deux exemplaires originaux remis à chacune des parties, 
        A <strong>Casablanca</strong>, le <strong>{{$Info->dateDebutLocationVehicules}}</strong> <br><br>
        <table border="1">
