        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="d-flex justify-content-end " style=" column-gap: 20px;">
              <a href="{{ROUTE('admin.Nouveau_client')}}" class="btn btn-primary">Ajouter un Nouveau_client client</a>
              <a href="{{route('admin.impression_clients')}}"class="btn btn-warning">Imprimer liste des Clients </a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="detail_client/{{$user->id}}" class="fa fa-eye" style="width: 20%"></a>
                  <a href="modifier_client/{{$user->id}}" class="fas fa-edit"style="width: 20%"></a>
                  <a href="supprimer_client/{{$user->id}}" class="fa fa-trash"style="width: 20%"></a>
                  <a href="impression_detail_client/{{$user->id}}"  class="fa fa-print" style="width: 20%"></a>
                </td>
              </tr>
