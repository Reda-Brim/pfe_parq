              ...
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="detail_vehicule/{{$vehicule->id}}" class="fa fa-eye" style="width: 20%"></a>
                   
                    <a href="modifier_vehicule/{{$vehicule->id}}" class="fas fa-edit" style="width: 20%"></a>
                    <a href="supprimer_vehicule/{{$vehicule->id}}" class="fa fa-trash " style="width: 20%"></a>
                    <a href="impression_detail_vehicule/{{$vehicule->id}}"  class="fa fa-print" style="width: 20%"></a>
                  </td>
                </tr>
